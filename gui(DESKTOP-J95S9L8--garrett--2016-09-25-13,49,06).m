...
%         hold off;
        ...
        handles.tracker.posx.feature = getFtrVal(iH,handles.tracker.posx.sampleImage,ftr);
        negx.feature = getFtrVal(iH,negx.sampleImage,ftr); 
        [handles.tracker.posx.mu,handles.tracker.posx.sig,negx.mu,negx.sig] = classiferUpdate(handles.tracker.posx,negx,handles.tracker.posx.mu,handles.tracker.posx.sig,negx.mu,negx.sig,lRate);% update distribution parameters  
        %% 更新参数
        centerx = x + w/2;
        centery = y + h/2;
        camt = camt + 1;
