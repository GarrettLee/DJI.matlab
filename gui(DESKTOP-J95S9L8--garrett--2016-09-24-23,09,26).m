...
handles.Timers.timerTrace = timer('Name', 'timer_trace','ExecutionMode', 'fixedSpacing', 'Period', 0.002 );
handles.Timers.timerTrace.StartFcn = @(~,~)timerC_Start(handles);
handles.Timers.timerTrace.TimerFcn = @(~,~)stop(handles.Timers.timerTrace);
...
handles.Timers.timerDisplay = timer('Name', 'timer_display','ExecutionMode', 'fixedSpacing', 'Period', 0.002 );
...
function x = timerC_start(handles)
